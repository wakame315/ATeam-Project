...
{
    { "data/SOUND/BGM_TITLE.wav", -1 },		        // BGM タイトル
    { "data/SOUND/BGM_GAME.wav", -1 },		        // BGM ゲーム
    { "data/SOUND/SE_000.wav", 0 },		            // SE タイトル画面決定音
    { "data/SOUND/SE_001.wav", 0 },		            // SE マッチング音
    { "data/SOUND/SE_002.wav", 0 },		            // SE 斬撃小
    { "data/SOUND/SE_003.wav", 0 },		            // SE 斬撃大
    { "data/SOUND/SE_004.wav", 0 },		            // SE 完全防御
    { "data/SOUND/SE_005.wav", -1 },		        // SE 歓声(ループ)
    { "data/SOUND/SE_006.wav", 0 },		            // SE ゴング1
    { "data/SOUND/SE_007.wav", 0 },		            // SE ゴング複数
    { "data/SOUND/SE_008.wav", 0 },		            // SE カード決定音
};
